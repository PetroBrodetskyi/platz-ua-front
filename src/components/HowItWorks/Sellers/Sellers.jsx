    ...
    <div className={scss.tabContent}>
      <ul className={scss.list}>
        <li className={scss.item}>
          <img src={manshopping} alt="Make product photos" className={scss.image} />
        ...
        <li className={scss.item}>
          ...
          <img src={shopping} alt="Publish your listing" className={scss.image} />
        </li>
        <li className={scss.item}>
          <img src={womantalking} alt="Communicate with buyers" className={scss.image} />
          <div className={scss.info}>
            <div className={scss.iconTitle}>
        ...
        <li className={scss.item}>
          ...
          <img src={creditcard} alt="Sell your product" className={scss.image} />
        </li>
      </ul>
