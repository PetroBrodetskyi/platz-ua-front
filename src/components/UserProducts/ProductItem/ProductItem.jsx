...
const ProductItem = ({ product, isEditing, updatedProduct, handleChange, handleConditionChange, handleEditClick, handleSaveClick, currentUser, exchangeRate, allComments, setNewComment, newComment, handleAddComment }) => {
