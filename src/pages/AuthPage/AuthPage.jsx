  ...
  return (
    <div className={scss.authPage}>
      ...
      <div className={scss.formContainer}>
        ...
        <p>
          Надаючи свої дані, ви підтверджуєте, що ознайомлені з нашою політикою
          конфіденційності та даєте свою згоду на обробку ваших персональних
          даних для зазначених цілей. Ви також маєте право в будь-який час
          відкликати свою згоду, зв'язавшись з нами за вказаними контактними
          даними.
        </p>
      </div>
